...
class KTensorModel(ReconstModel):
    """ Diffusion Kurtosis Tensor and Diffusion Tensor
    """
    def __init__(self, gtab, fit_method="WLS", *args, **kwargs):
        """ A Diffusion Kurtosis Tensor Model [1]_, [2]_.
        ...
        fit_method : str or callable
            ...
            'WLS' for weighted least squares
                dti.wls_fit_tensor
            'IWLS' for iteratively weighted least squares [5]
            ...
            'RK' or 'rekindle' or 'REKINDLE' for REKINDLE robust tensor fitting [4]
        ...
        .. [4] Tax C.M.W., Otte W.M., Viergever M.A., Dijkhuizen R.M., Leemans
           A., 2014. REKINDLE: Robust extraction of kurtosis INDices with
           linear estimation. MRM
        .. [5] Veraart J., 2013. Weighted linear least squares estimation of
           diffusion MRI parameters: strengths, limitations, and pitfalls.
           NeuroImage 81: 334-46
    ...
    def fit(self, data, mask=None):
        ...
        return KTensorFit(self, dki_params)



class KTensorFit(object):
...
def wls_fit_tensor(design_matrix, data, min_signal=1):
    ...
    dti_params = np.empty((len(data_flat), 6, 3))
